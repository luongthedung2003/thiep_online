...
<section class="py-14">
    ...
    <div class="flex-1 bg-white flex flex-col justify-start lg:justify-center items-center p-6 pt-10 lg:p-24">
        <div class="w-full max-w-md flex flex-col" id="login-form">
            ...
            <!-- Google Sign In -->
            <button class="w-full flex justify-center items-center gap-3 bg-green-50 hover:bg-green-100 text-green-900 font-semibold py-3 px-4 rounded-lg transition duration-200 mb-8 border border-green-100">
            ...
            <form action="#" method="POST" class="flex flex-col gap-5">
                ...
                <button type="button" class="w-full text-white bg-[#20C997] hover:bg-[#1BA87E] focus:ring-4 focus:ring-green-300 font-bold rounded-lg text-lg px-5 py-3.5 mt-2 flex justify-center items-center gap-2 transition duration-200">
